...
declare namespace $ {
	...
	export class $bog_LocalScript_button extends $mol_button_major {
	}
...
declare namespace $ {
	...
	export class $bog_LocalScript_logo extends $mol_icon_molecule {
	}
...
declare namespace $ {
	...
	type $mol_link_source__uri_bog_LocalScript_app_1 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_link_source['uri'] >
	>
	type $bog_LocalScript_button__title_bog_LocalScript_app_2 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_LocalScript_button['title'] >
	>
	type $mol_link__title_bog_LocalScript_app_3 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_link['title'] >
	>
	type $mol_link__uri_bog_LocalScript_app_4 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_link['uri'] >
	>
	type $mol_page__body_bog_LocalScript_app_5 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_page['body'] >
	>
	type $mol_text__text_bog_LocalScript_app_6 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_text['text'] >
	>
	type $mol_page__title_bog_LocalScript_app_7 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_page['title'] >
	>
	type $mol_page__body_bog_LocalScript_app_8 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_page['body'] >
	>
	export class $bog_LocalScript_app extends $mol_book2_catalog {
		Logo2( ): $bog_LocalScript_logo
		Theme( ): $mol_theme_auto
		Sources( ): $mol_link_source
		Lighter( ): $mol_lights_toggle
		Logout_button( ): $bog_LocalScript_button
		Docs_uri( ): $mol_link
		Docs( ): $mol_page
		Hello( ): $mol_text
		Page1( ): $mol_page
		menu_title( ): string
		Menu_logo( ): ReturnType< $bog_LocalScript_app['Logo2'] >
		param( ): string
		plugins( ): readonly(any)[]
		menu_tools( ): readonly(any)[]
		menu_foot( ): readonly(any)[]
		Spread_default( ): ReturnType< $bog_LocalScript_app['Docs'] >
		spreads( ): ({ 
			'hello': ReturnType< $bog_LocalScript_app['Page1'] >,
		}) 
	}
