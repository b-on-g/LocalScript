...
;
	($.$bog_LocalScript_logo_demo) = class $bog_LocalScript_logo_demo extends ($.$mol_example_small) {
		Logo(){
	...
	($mol_mem(($.$bog_LocalScript_logo_demo.prototype), "Logo"));
...
;
	($.$bog_LocalScript_button_demo) = class $bog_LocalScript_button_demo extends ($.$mol_example_small) {
		Login(){
	...
	($mol_mem(($.$bog_LocalScript_button_demo.prototype), "Login"));
	($mol_mem(($.$bog_LocalScript_button_demo.prototype), "Logout"));
...
;
	($.$bog_LocalScript_docs) = class $bog_LocalScript_docs extends ($.$mol_app_demo) {
		menu_title(){
			return "Демонстрации";
		}
		source_prefix(){
			return "https://github.com/b-on-g/LocalScript/tree/master/";
		}
		sources_uri(){
			return "https://github.com/b-on-g/LocalScript/";
		}
	};
