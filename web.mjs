...
;
	($.$bog_LocalScript_button) = class $bog_LocalScript_button extends ($.$mol_button_major) {};
...
;
	($.$bog_LocalScript_logo) = class $bog_LocalScript_logo extends ($.$mol_icon_molecule) {};
...
var $;
(function ($) {
    $mol_style_attach("bog/LocalScript/logo/logo.view.css", "[bog_LocalScript_logo] {\n\tanimation: rotate 4s infinite;\n}\n\n@keyframes rotate {\n\t0% {\n\t\ttransform: rotate(0deg)\n\t}\n\n\t100% {\n\t\ttransform: rotate(360deg)\n\t}\n}\n");
})($ || ($ = {}));
...
;
	($.$bog_LocalScript_app) = class $bog_LocalScript_app extends ($.$mol_book2_catalog) {
		Logo2(){
			const obj = new this.$.$bog_LocalScript_logo();
			return obj;
		}
		Theme(){
		...
		Sources(){
			...
			(obj.uri) = () => ("https://github.com/b-on-g/LocalScript");
			return obj;
		}
		Lighter(){
		...
		Logout_button(){
			const obj = new this.$.$bog_LocalScript_button();
			(obj.title) = () => ("Выйти");
			return obj;
		}
		Docs_uri(){
			...
			(obj.uri) = () => ("http://localhost:9080/bog/LocalScript/docs/-/test.html");
			return obj;
		}
		Docs(){
			const obj = new this.$.$mol_page();
		...
		Hello(){
			const obj = new this.$.$mol_text();
			(obj.text) = () => ("# Привет https://mol.hyoo.ru/#!section=docs/=6leyma_5ks814]\nИнструкция по шаблону читай на https://github.com/b-on-g/LocalScript");
			return obj;
		}
		Page1(){
			const obj = new this.$.$mol_page();
	...
	($mol_mem(($.$bog_LocalScript_app.prototype), "Logo2"));
	($mol_mem(($.$bog_LocalScript_app.prototype), "Theme"));
	($mol_mem(($.$bog_LocalScript_app.prototype), "Sources"));
	($mol_mem(($.$bog_LocalScript_app.prototype), "Lighter"));
	($mol_mem(($.$bog_LocalScript_app.prototype), "Logout_button"));
	($mol_mem(($.$bog_LocalScript_app.prototype), "Docs_uri"));
	($mol_mem(($.$bog_LocalScript_app.prototype), "Docs"));
	($mol_mem(($.$bog_LocalScript_app.prototype), "Hello"));
	($mol_mem(($.$bog_LocalScript_app.prototype), "Page1"));
